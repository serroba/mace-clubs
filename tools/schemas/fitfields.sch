...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
    ...
    <pattern id="fit-field-contract">
        <rule context="fitField">
            ...
            <assert test="not(@displayInChart = 'true') or @unitLabel = '@Strings.FitPeakUnit' or @unitLabel = '@Strings.FitSwingsUnit' or @unitLabel = '@Strings.FitCadenceUnit' or @unitLabel = '@Strings.FitScoreUnit' or @unitLabel = '@Strings.FitPhaseUnit'">Charts must display an approved recorded unit.</assert>
